...
class Mapa {
    ...
    public Punto vertice(int columna, int fila, int numero){
            ...
            Punto p = null;
        //Marcamos los puntos
            if(numero ==0)p = new Punto(centro.x - lado/2, centro.y + 15, centro.z);
            else if(numero==1)p = new Punto(centro.x + lado/2, centro.y + 15, centro.z);
            else if(numero==2)p = new Punto(centro.x + lado/1, centro.y + 00, centro.z);
            else if(numero==3)p = new Punto(centro.x + lado/2, centro.y - 15, centro.z);
            else if(numero==4)p = new Punto(centro.x - lado/2, centro.y - 15, centro.z);
            else if(numero==5)p = new Punto(centro.x - lado/1, centro.y + 00, centro.z);
    ...
    public int caracontraria(int cara){
        int respuesta = 0;
        if(cara ==1) respuesta =4;
        else if(cara == 2) respuesta =5;
        else if(cara == 3) respuesta =6;
        else if(cara == 4) respuesta =1;
        else if(cara == 5) respuesta =2;
        else if(cara == 6) respuesta = 3;
    ...
    public ArrayList<ArrayList<Phexagono> > intermedios(Phexagono origen, Phexagono destino){
        ...
        int caraentrada = -1;
            ...
            cpp0[0][0]=false;cpp0[0][1]=false;cpp0[0][2]=false;cpp0[0][3]=false;cpp0[0][4]=true;cpp0[0][5]=true;
            cpp0[1][0]=false;cpp0[1][1]=false;cpp0[1][2]=false;cpp0[1][3]=true;cpp0[1][4]=true;cpp0[1][5]=true;
            cpp0[2][0]=false;cpp0[2][1]=false;cpp0[2][2]=false;cpp0[2][3]=true;cpp0[2][4]=true;cpp0[2][5]=false;
            cpp0[3][0]=false;cpp0[3][1]=true;cpp0[3][2]=true;cpp0[3][3]=false;cpp0[3][4]=false;cpp0[3][5]=false;
            cpp0[4][0]=true;cpp0[4][1]=true;cpp0[4][2]=true;cpp0[4][3]=false;cpp0[4][4]=false;cpp0[4][5]=false;
            cpp0[5][0]=true;cpp0[5][1]=true;cpp0[5][2]=false;cpp0[5][3]=false;cpp0[5][4]=false;cpp0[5][5]=false;
            ...
            cpp1[0][0]=false;cpp1[0][1]=false;cpp1[0][2]=false;cpp1[0][3]=true;cpp1[0][4]=true;cpp1[0][5]=false;
            cpp1[1][0]=false;cpp1[1][1]=false;cpp1[1][2]=true;cpp1[1][3]=true;cpp1[1][4]=false;cpp1[1][5]=false;
            cpp1[2][0]=false;cpp1[2][1]=true;cpp1[2][2]=false;cpp1[2][3]=false;cpp1[2][4]=false;cpp1[2][5]=false;
            cpp1[3][0]=true;cpp1[3][1]=true;cpp1[3][2]=false;cpp1[3][3]=false;cpp1[3][4]=false;cpp1[3][5]=false;
            cpp1[4][0]=true;cpp1[4][1]=false;cpp1[4][2]=false;cpp1[4][3]=false;cpp1[4][4]=false;cpp1[4][5]=true;
            cpp1[5][0]=false;cpp1[5][1]=false;cpp1[5][2]=false;cpp1[5][3]=false;cpp1[5][4]=true;cpp1[5][5]=false;
            ...
            cpn0[0][0]=false;cpn0[0][1]=true;cpn0[0][2]=true;cpn0[0][3]=false;cpn0[0][4]=false;cpn0[0][5]=false;
            cpn0[1][0]=true;cpn0[1][1]=false;cpn0[1][2]=false;cpn0[1][3]=false;cpn0[1][4]=false;cpn0[1][5]=true;
            cpn0[2][0]=true;cpn0[2][1]=false;cpn0[2][2]=false;cpn0[2][3]=false;cpn0[2][4]=true;cpn0[2][5]=true;
            cpn0[3][0]=false;cpn0[3][1]=false;cpn0[3][2]=false;cpn0[3][3]=false;cpn0[3][4]=true;cpn0[3][5]=true;
            cpn0[4][0]=false;cpn0[4][1]=false;cpn0[4][2]=true;cpn0[4][3]=true;cpn0[4][4]=false;cpn0[4][5]=false;
            cpn0[5][0]=false;cpn0[5][1]=true;cpn0[5][2]=true;cpn0[5][3]=true;cpn0[5][4]=false;cpn0[5][5]=false;
            ...
            cpn1[0][0]=false;cpn1[0][1]=false;cpn1[0][2]=true;cpn1[0][3]=true;cpn1[0][4]=false;cpn1[0][5]=false;
            cpn1[1][0]=false;cpn1[1][1]=false;cpn1[1][2]=true;cpn1[1][3]=false;cpn1[1][4]=false;cpn1[1][5]=false;
            cpn1[2][0]=true;cpn1[2][1]=true;cpn1[2][2]=false;cpn1[2][3]=false;cpn1[2][4]=false;cpn1[2][5]=false;
            cpn1[3][0]=true;cpn1[3][1]=false;cpn1[3][2]=false;cpn1[3][3]=false;cpn1[3][4]=false;cpn1[3][5]=true;
            cpn1[4][0]=false;cpn1[4][1]=false;cpn1[4][2]=false;cpn1[4][3]=false;cpn1[4][4]=false;cpn1[4][5]=true;
            cpn1[5][0]=false;cpn1[5][1]=false;cpn1[5][2]=false;cpn1[5][3]=true;cpn1[5][4]=true;cpn1[5][5]=false;
        ...
        while(actual.getColumna() != destino.getColumna() || actual.getFila() != destino.getFila()){
            ...
            while(salida ==null && contador_cara <=6){
                ...
                if(Op.mayorque(pendiente, pu)){
                    if(cpp1[caraentrada-1][contador_cara-1]) salida = recta.corte(segmento_caras[contador_cara-1]);
                }else if(Op.mayorque(pendiente, 0) && Op.menorque(pendiente, pu)){
                    if(cpp0[caraentrada-1][contador_cara-1]) salida = recta.corte(segmento_caras[contador_cara-1]);
                }else if(Op.menorque(pendiente, 0) && Op.mayorque(pendiente, -pu)){
                    if(cpn0[caraentrada-1][contador_cara-1]) salida = recta.corte(segmento_caras[contador_cara-1]);
                }else if(Op.menorque(pendiente, -pu)){
                    if(cpn1[caraentrada-1][contador_cara-1]) salida = recta.corte(segmento_caras[contador_cara-1]);
                }else if(Op.iguales(pendiente, 0)){
                    if(caraentrada == 23) salida = recta.corte(segmento_caras[4]);
                    else if (caraentrada == 56) salida = recta.corte(segmento_caras[2]);
                ...
                if(caraentrada != contador_cara) salida = recta.corte(segmento_caras[contador_cara-1]);
                }
                contador_cara++;
            }
